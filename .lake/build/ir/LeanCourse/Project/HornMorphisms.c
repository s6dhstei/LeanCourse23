...
// Imports: Init LeanCourse.Common Mathlib.AlgebraicTopology.Quasicategory LeanCourse.Project.AuxiliaryLemmas
#include <lean/lean.h>
...
lean_object* initialize_LeanCourse_Project_AuxiliaryLemmas(uint8_t builtin, lean_object*);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_LeanCourse_Project_AuxiliaryLemmas(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
